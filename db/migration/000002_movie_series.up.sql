...
ALTER TABLE user_rooms ALTER COLUMN id SET NOT NULL;
ALTER TABLE user_rooms ALTER COLUMN user_id SET NOT NULL;
ALTER TABLE user_rooms ALTER COLUMN room_id SET NOT NULL;
ALTER TABLE user_rooms ALTER COLUMN joined_at SET NOT NULL;
...
ALTER TABLE user_rooms_chat ALTER COLUMN id SET NOT NULL;
ALTER TABLE user_rooms_chat ALTER COLUMN room_id SET NOT NULL;
ALTER TABLE user_rooms_chat ALTER COLUMN user_id SET NOT NULL;
ALTER TABLE user_rooms_chat ALTER COLUMN message SET NOT NULL;
ALTER TABLE user_rooms_chat ALTER COLUMN sent_at SET NOT NULL;