...
ALTER TABLE movie_history ALTER COLUMN user_id SET NOT NULL;
ALTER TABLE movie_history ALTER COLUMN movie_id SET NOT NULL;
ALTER TABLE movie_history ALTER COLUMN watched_duration SET NOT NULL;
ALTER TABLE movie_history ALTER COLUMN last_watched SET NOT NULL;
