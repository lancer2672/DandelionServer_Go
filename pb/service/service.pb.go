...
var file_service_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0x09, 0x0a, 0x09, 0x44, 0x61, 0x6e, 0x64, 0x65, 0x6c, 0x69,
	...
	0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x74, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x57, 0x61, 0x74, 0x63,
	0x68, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x12, 0x1c, 0x2e, 0x70, 0x62, 0x2e,
	...
	0x1a, 0x2f, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x2f, 0x77, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e,
	0x67, 0x2f, 0x7b, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x6c, 0x0a, 0x0e, 0x47,
	0x65, 0x74, 0x56, 0x6f, 0x74, 0x65, 0x73, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x12, 0x19, 0x2e,
	...
	0x74, 0x56, 0x6f, 0x74, 0x65, 0x73, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x23, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1d, 0x12, 0x1b, 0x2f, 0x6d,
	0x6f, 0x76, 0x69, 0x65, 0x2f, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f,
	0x7b, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0xa0, 0x01, 0x5a, 0x33, 0x67, 0x69,
...
var file_service_service_proto_goTypes = []interface{}{
	...
	(*request.GetMovieHistoryResponse)(nil),   // 13: pb.GetMovieHistoryResponse
	(*request.GetListGenresResponse)(nil),     // 14: pb.GetListGenresResponse
	(*model.Movie)(nil),                       // 15: pb.Movie
	(*request.GetListMoviesResponse)(nil),     // 16: pb.GetListMoviesResponse
	(*request.GetMoviesByGenreResponse)(nil),  // 17: pb.GetMoviesByGenreResponse
	(*request.GetMoviesBySerieResponse)(nil),  // 18: pb.GetMoviesBySerieResponse
	(*request.GetRecentMoviesResponse)(nil),   // 19: pb.GetRecentMoviesResponse
	(*request.SearchMoviesResponse)(nil),      // 20: pb.SearchMoviesResponse
	(*request.GetWatchingMoviesResponse)(nil), // 21: pb.GetWatchingMoviesResponse
	(*request.GetVotesByUserResponse)(nil),    // 22: pb.GetVotesByUserResponse
}
var file_service_service_proto_depIdxs = []int32{
	...
	10, // 10: pb.Dandelion.GetWatchingMovies:input_type -> pb.GetWatchingMoviesRequest
	11, // 11: pb.Dandelion.GetVotesByUser:input_type -> pb.GetVotesByUserRequest
	12, // 12: pb.Dandelion.CreateMovieHistory:output_type -> google.protobuf.Empty
	13, // 13: pb.Dandelion.GetMovieHistory:output_type -> pb.GetMovieHistoryResponse
	14, // 14: pb.Dandelion.GetListGenres:output_type -> pb.GetListGenresResponse
	15, // 15: pb.Dandelion.CreateMovie:output_type -> pb.Movie
	16, // 16: pb.Dandelion.GetListMovies:output_type -> pb.GetListMoviesResponse
	15, // 17: pb.Dandelion.GetMovie:output_type -> pb.Movie
	17, // 18: pb.Dandelion.GetMoviesByGenre:output_type -> pb.GetMoviesByGenreResponse
	18, // 19: pb.Dandelion.GetMoviesBySerie:output_type -> pb.GetMoviesBySerieResponse
	19, // 20: pb.Dandelion.GetRecentMovies:output_type -> pb.GetRecentMoviesResponse
	20, // 21: pb.Dandelion.SearchMovies:output_type -> pb.SearchMoviesResponse
	21, // 22: pb.Dandelion.GetWatchingMovies:output_type -> pb.GetWatchingMoviesResponse
	22, // 23: pb.Dandelion.GetVotesByUser:output_type -> pb.GetVotesByUserResponse
