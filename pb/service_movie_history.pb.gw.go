...
func RegisterDandelionHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DandelionServer) error {
	...
	mux.Handle("POST", pattern_Dandelion_CreateMovieHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.Dandelion/CreateMovieHistory", runtime.WithHTTPPathPattern("/v1/create_movie_history"))
		if err != nil {
...
func RegisterDandelionHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DandelionClient) error {
	...
	mux.Handle("POST", pattern_Dandelion_CreateMovieHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.Dandelion/CreateMovieHistory", runtime.WithHTTPPathPattern("/v1/create_movie_history"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Dandelion_CreateMovieHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "create_movie_history"}, ""))
)
